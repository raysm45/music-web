  ...
  const renderAppearance = () => (
    <>
      ...
      <SettingSection title={tt("Tampilan Pemutar", "Player Look")}>
        ...
        <ToggleRow label={tt("Sampul bergerak (Living Cover)", "Living Cover Motion")} hint={tt("Tampilkan video animated artwork saat tersedia untuk lagu yang diputar; kalau tidak tersedia, tetap pakai sampul statis biasa", "Show an animated-artwork video when one is available for the playing track; falls back to the plain static cover otherwise")} checked={settings.livingCover !== false} onChange={set("livingCover")} />
      </SettingSection>
