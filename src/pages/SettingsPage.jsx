  ...
  const renderAppearance = () => (
    <>
      ...
      <SettingSection title={tt("Tampilan Pemutar", "Player Look")}>
        ...
        <ToggleRow label={tt("Sampul animasi (khusus Now Playing)", "Animated Artwork (Now Playing only)")} hint={tt("Cari video sampul album animasi (kalau tersedia); sampul statis tetap tampil dulu sampai animasinya siap diputar. Pakai data ekstra.", "Looks up an animated album cover video when available; the static cover always shows first until the animation is ready to play. Uses extra data.")} checked={!!settings.animatedArtwork} onChange={set("animatedArtwork")} />
      </SettingSection>
